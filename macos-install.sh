...
# Note: The -fopenmp option is not supported by compilers shipped with Xcode by default.
# This installation will not support thread parallelism.
...
mexcmd -v -cxx -lblas -llapack -lm CXXOPTIMFLAGS=-O3 solveTV1_kolmogorov *.o
